    ...
    [
        ...
        new("Pierwsze uruchomienie",
            ...
            [
                ...
                new("3. Włącz powiadomienia",
                    "Zakładka Skrzynka. Jeśli brakuje uprawnienia, na górze pojawi się pasek z przyciskiem „Ustawienia” — prowadzi prosto do systemowej listy dostępu do powiadomień. Bez tego nic nie złapie się samo."),
        ...
        new("Codzienny obieg",
            "W normalnym dniu nie robisz nic. Aplikacja łapie płatności z powiadomień, a Ty raz na jakiś czas porządkujesz Skrzynkę.",
            [
        ...
        new("Miesiąc i koperty",
            ...
            [
                ...
                new("Podpowiedzi",
                    "Szare przyciski z kwotą przepisują liczbę jednym tapnięciem — sumę zaplanowanych przychodów do pola środków, albo sumę rat funduszy do koperty „Rezerwy”. Pojawiają się tylko wtedy, gdy jest co podpowiedzieć."),
        ...
        new("Gdy coś wygląda dziwnie",
            ...
            [
                ...
                new("Powiadomienie nie utworzyło transakcji",
                    "Trzy najczęstsze powody: aplikacja bankowa nie jest na liście obsługiwanych, brak uprawnienia do powiadomień, albo treść powiadomienia nie dała się rozczytać. Wtedy dodaj wydatek ręcznie i uzgodnij saldo konta."),
